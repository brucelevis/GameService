...
INCPATH=-I. -IItem -INetWork -I$(BEHAVIORPATH) -I$(PROTOBUF_DIR)/include -I$(BOOST_ROOT)
...
LIBRARY=$(PROTOBUF_DIR)/lib/libprotobuf.a -L$(BOOST_ROOT)/stage/lib/ $(BEHAVIORPATH)/lib/libbehaviac.a
LDFLAGS = -lboost_system -lboost_thread

PROTO_SRC=P_Asset.proto P_Property.proto P_Protocol.proto P_Server.proto
