...
class MsgItem : public ::google::protobuf::Message {
 public:
  ...
  // optional .Adoter.Asset.MsgType type = 2;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 2;
  inline ::Adoter::Asset::MsgType type() const;
  inline void set_type(::Adoter::Asset::MsgType value);
...
inline ::Adoter::Asset::MsgType MsgItem::type() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.MsgItem.type)
  return static_cast< ::Adoter::Asset::MsgType >(type_);
}
inline void MsgItem::set_type(::Adoter::Asset::MsgType value) {
  assert(::Adoter::Asset::MsgType_IsValid(value));
  set_has_type();
  type_ = value;
...
template <> struct is_proto_enum< ::Adoter::Asset::MsgType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Adoter::Asset::MsgType>() {
  return ::Adoter::Asset::MsgType_descriptor();
}
